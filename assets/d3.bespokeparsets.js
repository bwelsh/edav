...
(function() {
  d3.parsets = function() {
        ...
        function updateRibbons() {
          ...
          mouse.enter().append("path")
              .on("mousemove", function(d, i) {
                ...
                showTooltip(tooltipFormat(d, i, total));
        ...
        function updateCategories(g) {
          ...
          category
              .on("mousemove", function(d) {
                ...
                showTooltip(categoryFormat(d.name, d.dimension.name) + "<br>" + d.count + ", " + percent(d.count / total));
                d3.event.stopPropagation();
              })
          ...
          category.select("text")
              .text(truncateText(function(d) { return categoryFormat(d.name, d.dimension.name); }, function(d) { return d.dx; }));
        }
      });
    }
    ...
    parsets.categoryFormat = function(_) {
      if (!arguments.length) return categoryFormat;
      categoryFormat = _;
      return parsets;
    };
    ...
    parsets.tooltipFormat = function(_) {
      if (!arguments.length) return tooltipFormat;
      tooltipFormat = _ == null ? defaultTooltip : _;
      return parsets;
    };
